  ...
  refs: {
        ...
        Mode(
          ...
          starts: Mode(
            ...
            contains: [
              ...
              ModeReference('~contains~2~starts~contains~3'),
              ModeReference('~contains~2~starts~contains~4'),
              ModeReference('~contains~2~starts~contains~5'),
              ModeReference('~contains~2~starts~contains~6'),
              ModeReference('~contains~2~starts~contains~7'),
              ModeReference('~contains~2~starts~contains~7~contains~8'),
              ModeReference('~contains~2~starts~contains~7~contains~9'),
              ModeReference('~contains~2~starts~contains~7~contains~10'),
              ModeReference('~contains~2~starts~contains~7~contains~11'),
              ModeReference('~contains~2~starts~contains~7~contains~12'),
              ModeReference('~contains~2~starts~contains~7~contains~13'),
    ...
    '~contains~3~starts~contains~15': Mode(
      ...
      contains: [
        ...
        ModeReference('~contains~3~starts~contains~15~contains~4'),
